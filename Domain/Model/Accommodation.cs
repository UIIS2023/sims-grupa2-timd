...
namespace SimsProject.Domain.Model
{
    public class Accommodation : ISerializable
    {
        ...
        public string[] ToCsv()
        {
            string[] csvValues = { Id.ToString(), Name, Location.Id.ToString(), Type.Id.ToString(), MaxGuestNumber.ToString(), MinReservationDays.ToString(), MinDaysBeforeCancellation.ToString(), Owner.Id.ToString(), Cover.Id.ToString() };
            return csvValues;
        }
        ...
        public void FromCsv(string[] values)
        {
            ...
            Cover = new Image() { Id = Convert.ToInt32(values[8]) };
        }
    }
}
